...
-   The **intercepts** give estimates of the Runs when there are no runners on base (Score = 0). With the bases empty, we expect the team will score 0.63, 0.33, and 0.14 runs with 0, 1, and 2 outs, respectively.
